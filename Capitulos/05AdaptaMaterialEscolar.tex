...
\begin{resumen}
	En este capítulo se explicará para quién va a desarrollarse el proyecto de AdaptaMaterialEscolar, cuándo y cómo se comenzó a planificar y los requisitos para la aplicación web.
\end{resumen}
...
\label{cap5:sec:diseño}
	...
	\subsection{Tercera etapa}
		Una vez que se hizo la versión 1.0 del prototipo, se propuso hacer una iteración competitiva para ver si este prototipo se podía mejorar. Cada miembro del equipo realizó, de forma individual y sin influir unos en los otros, un prototipo propio partiendo del inicial.