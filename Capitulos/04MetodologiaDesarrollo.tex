...
\label{cap4:sec:introduccion}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=1\textwidth]{Imagenes/Bitmap/desarrolloCascada}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=1\textwidth]{Imagenes/Bitmap/desarrolloEspiral}
...
\label{cap4:sec:kanban}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=1\textwidth]{Imagenes/Bitmap/tareaVariosUsuarios}
