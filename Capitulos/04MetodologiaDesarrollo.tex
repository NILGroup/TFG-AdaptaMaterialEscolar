...
\begin{resumen}
	...
	En este capítulo se describe la metodología de desarrollo que se usa en el proyecto. En la sección 3.1 se hace una introducción de los tipos de metodologías que hay. En la sección 3.2 se explica la metodología que se ha elegido. Por último, en la sección 3.3 se describen los tipos de pruebas que se realizarán. 
...
\label{cap4:sec:kanban}
	...
	A diferencia de otras metodologías ágiles, \kanban \space es mejor prescriptivo, es decir, solo tiene tres reglas:
	\begin{enumerate}
