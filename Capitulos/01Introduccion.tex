...
\begin{resumen}
	En este capítulo se realiza la introducción del Trabajo de Fin de Grado que va a ser presentado. En la sección \ref{cap1:sec:motivacion} se explicará la motivación que ha dado lugar al trabajo. En la sección \ref{cap1:sec:objetivos} el objetivo que se pretende alcanzar. Por último, en la sección \ref{cap1:sec:estructuraMemoria} se explica cómo está estructurada la memoria.
\end{resumen}
