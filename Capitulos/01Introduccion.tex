...
La estructura del proyecto está formada por nueve capítulos, incluyendo este introductorio, en el que se explica la motivación y el objetivo del trabajo. A continuación, se expone el resumen de cada uno de ellos:
...
\begin{itemize}
	...
	\item En el \textbf{capítulo tres}, se explica la metodología de desarrollo que ha sido empleada durante todo el proceso y el motivo por el que se escogió.
	\item En el \textbf{capítulo cuatro}, se describen las herramientas utilizadas en el desarrollo del  proyecto.
	\item En el \textbf{capítulo cinco}, se explica cada una de las iteraciones con las que se realizó la captura de requisitos, el resultado de éstas y el diseño final de la aplicación.
	\item En el \textbf{capítulo seis}, COMPLETAR.
	\item En el \textbf{capítulo siete}, COMPLETAR.
	\item En el \textbf{capítulo ocho}, se desarrolla el trabajo individual que ha realizado cada miembro del equipo del proyecto.
