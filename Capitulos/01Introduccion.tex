...
\begin{resumen}
	En este capítulo se realiza la introducción del Trabajo de Fin de Grado que va a ser presentado. En la sección \ref{cap1:sec:motivacion} se explicará la motivación que ha dado lugar al trabajo. A continuación, el objetivo que se pretende alcanzar. Por último, la estructura del proyecto final.
\end{resumen}


%------Primera sección: Motivación------%
\section{Motivación}
%---------------------------------------%
...
%------Tercera sección: Estructura de la memoria------%
\section{Estructura de la memoria}
%-----------------------------------------------------%
\label{cap1:sec:estructuraMemoria}
