...
\begin{resumen}
En este capítulo se realiza la introducción del Trabajo de Fin de Grado que va a ser presentado. Primero, en la Sección \ref{cap1:motivacion}, se explicará la motivación que ha dado lugar al trabajo. A continuación, en la Sección \ref{cap1:objetivo}, el objetivo que se pretende alcanzar. Por último, la estructura del proyecto final, en la Sección\label{cap1:estructura}.  
\end{resumen}
...
La herramienta estará basada en una Arquitectura Orientada a Servicios (SOA), es decir, principalmente recurriremos a aplicaciones externas (servicios) que nos proporcionen funcionalidades internas a nuestra aplicación.
...
\begin{itemize}
	...
	\item En el \textbf{capítulo cinco} se explican cada una de las iteraciones con las que se realizó la captura de requisitos, el resultado de éstas y su evaluación y el diseño de la aplicación.
	\item En el \textbf{capítulo seis} se presenta el trabajo individual que ha realizado cada miembro del equipo en el proyecto.
