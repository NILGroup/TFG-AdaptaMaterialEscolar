...
\label{cap3:sec:react}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/reactSinJSX}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/reactConJSX}
...
\label{cap3:sec:apiarasaac}
	...
	La API de ARASAAC consta de cuatro apartados, cada uno de los cuales tiene una ruta web dependiendo de lo que se quiera consultar: ``materiales'', ``pictogramas'', ``palabras clave'' y ``usuarios''. Como en este proyecto usaremos solo la búsqueda de pictogramas, nos centraremos en el apartado de pictogramas. Dicho apartado consta de nueve rutas, todas ellas con el método de petición ``\textit{GET}'':
	\begin{itemize}
		\item \textbf{/pictograms/all/\{locale\}}:
		\item \textbf{/pictograms/\{idPictogram\}}:
		\item \textbf{/pictograms/\{locale\}/\{idPictogram\}}:
		\item \textbf{/pictograms/\{idPictogram\/languages/\{languages\}}:
		\item \textbf{/pictograms/\{locale\}/search/\{searchText\}}:
		\item \textbf{/pictograms/\{locale\}/bestsearch/\{searchText\}}:
		\item \textbf{/pictograms/\{locale\}/wordnet/\{wordnet\}/id/\{sysnet\}}:
		\item \textbf{/pictograms/\{locale\}/days/\{days\}}:
		\item \textbf{/pictograms/\{locale\}/new/\{newItems\}}:
	\end{itemize}
