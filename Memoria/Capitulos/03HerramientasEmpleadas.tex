...
\label{cap3:sec:jest}
	...
	\begin{enumerate}
		...
		\begin{lstlisting}[language=Javascript]
			...
			module.exports = suma;
		\end{lstlisting}
		\item Crear un fichero \textit{Javascript} donde contendrá la prueba (por ejemplo \textit{suma.test.js}). Para escribir la prueba, tiene que seguir el siguiente esquema:
		...
		\begin{figure}[ht!]
			\begin{center}
				\includegraphics[width=0.55\textwidth]{Imagenes/Bitmap/ejemploTestCorrecto}
		...
		\begin{figure}[ht!]
			\begin{center}
				\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/ejemploTestIncorrecto}
...
\label{cap3:sec:wordsearch}
	...
	\begin{itemize}
		...
		\item dictionary: Es un array de strings que contiene las palabras que debe contener la sopa de letras. Por defecto tiene un valor vacío.
	...
	Una vez creada la sopa de letras, el paquete proporciona las siguientes funciones\footnote{Para cada ejemplo, se han usado las opciones de configuración de la figura \ref{fig:wordsearchoptions}. Así mismo, se han ejecutado dichas funciones una sola vez y seguidas, dando como resultado el mismo tablero.}:
	\begin{itemize}
		\item grid(): Devuelve un array de caracteres donde cada posición representa una letra de la sopa de letras. En la figura \ref{fig:wordsearchgrid} se puede ver un ejemplo del resultado de esta función.
		...
		\item toString(): Devuelve un array de strings donde cada posición representa una fila de la sopa de letras. En la figura \ref{fig:wordsearchtostring} se puede ver un ejemplo del resultado de esta función.
		...
		\begin{figure}[ht!]
			\begin{center}
				\includegraphics[width=0.2\textwidth]{Imagenes/Bitmap/wordsearchread}
