...
La herramienta que resulte de este TFG permitirá crear material escolar personalizado ajustado a cada alumno,  permitiendo generar resúmenes, esquemas, traducciones a pictogramas, cambios de formato o la creación de diferentes tipos de ejercicios (como por ejemplo, ejercicios para rellenar espacios en blanco, sopas de letras o ejercicios de relacionar conceptos), etc.

La herramienta estará basada en una Arquitectura Orientada a Servicios (SOA), es decir, principalmente recurriremos a algunas aplicaciones externas (servicios) que proporcionen funcionalidad a nuestra aplicación.
...
\begin{itemize}
	\item En el  \textbf{capítulo dos} se presenta el estado del arte, donde se explicará el dominio en el que se enmarca el proyecto.
	...
	\item En el \textbf{capítulo cinco} se explica la fase de captura de requisitos, diseño,  implementación y evaluación de la aplicación.
	\item En el \textbf{capítulo seis} se muestra cómo se ha hecho la evaluación de AdaptaMaterialEscolar.
