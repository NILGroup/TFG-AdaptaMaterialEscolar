...
\label{cap6:sec:capturaRequisitos}
	...
	\begin{longtable}[c]{p{9.7cm}cc}
		...
		\multicolumn{1}{|p{9.7cm}|}{Añadir leyenda de colores para diferenciar las asignaturas, para que los alumnos relacionen cada asignatura con un color determinado y cambien de clase sin confundirse} & \multicolumn{1}{c|}{\multirow{3}{*}{1}} & \multicolumn{1}{c|}{\multirow{3}{*}{3}} \\ \hline
