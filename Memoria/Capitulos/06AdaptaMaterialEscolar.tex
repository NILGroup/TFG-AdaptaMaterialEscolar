...
%-----------------------------------%
	...
	En la figura \ref{fig:adaptamaterialescolarInicio2} se puede ver, en la parte de la derecha, el editor. 
	...
	\begin{enumerate}
		...
		\begin{enumerate}
			...
			\end{itemize}
		\end{enumerate}
		\item Por último, se hará una llamada a \textit{writeInEditor()}, una función local de \textit{WordSearchModal}, cuyo objetivo es escribir en el editor la sopa de letras.
	\end{enumerate}
