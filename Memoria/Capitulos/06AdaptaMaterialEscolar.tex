...
%-----------------------------------%
	...
	\begin{enumerate}
		...
		\begin{figure}[ht!]
			\begin{center}
				\includegraphics[width=1\textwidth]{Imagenes/Bitmap/fillgapsSequence2}
