...
\label{cap4:sec:kanban}
	...
	\begin{itemize}
		...
		\item \textit{In Progress}: Son tareas en las que el equipo de desarrollo ha comenzado a trabajar.
		\item \textit{Ready for Testing}: Son tareas listas para ser probadas.
		\item \textit{Testing}: Son tareas que se están probando. Dependiendo del tipo de tarea se probará de una forma u otra. En la sección \ref{cap4:sec:pruebas} se dan más detalles de cómo se prueban las tareas de memoria y las de implementación.
