...
\label{cap5:sec:kanban}
	...
	\begin{itemize}
		...
		\item \textit{Testing}: Son tareas que se están probando. Dependiendo del tipo de tarea se probará de una forma u otra. En la sección \ref{cap5:sec:pruebas} se dan más detalles de cómo se prueban las tareas de memoria y las de implementación.
