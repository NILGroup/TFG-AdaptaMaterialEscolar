...
\figura{BitMap/imgdefiniciones}{width=0.8\textwidth}{fig:imgdefiniciones}{Interfaz del componente Definiciones}
...
\figura{BitMap/imgdef1}{width=0.8\textwidth}{fig:imgdef1}{Ejemplo 1 del componente Definiciones}
\figura{BitMap/imgdef2}{width=0.9\textwidth}{fig:imgdef2}{Ejemplo 2 del componente Definiciones}
...
\figura{BitMap/imgdesarrollo}{width=0.8\textwidth}{fig:imgdesarrollo}{Interfaz del componente Desarrollo}
...
\figura{BitMap/imgdes1}{width=0.8\textwidth}{fig:imgdes1}{Ejemplo del componente Desarrollo}
...
\figura{BitMap/imgvf}{width=0.8\textwidth}{fig:imgvf}{Ejemplo del componente Verdadero o Falso}
