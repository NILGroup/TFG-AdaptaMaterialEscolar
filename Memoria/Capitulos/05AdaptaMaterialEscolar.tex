...
\label{cap5:sec:implementacion}
	...
	\begin{itemize}
		...
		\item Rellenar huecos. Permite crear un ejercicio de completar huecos, a partir de un texto inicial, haciendo clic en las palabras en las que se quiera dejar el hueco.
		...
		\item Verdadero y falso. Permite crear una lista de oraciones y añade al final una línea para contestar dicha oración con verdadero o falso.
	\end{itemize}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.94\textwidth]{Imagenes/Bitmap/adaptamaterialescolarMovible}
...
%-----------------------------------%
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.84\textwidth]{Imagenes/Bitmap/wordsearchConfig}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.74\textwidth]{Imagenes/Bitmap/wordsearchPreview}
	...
	\begin{enumerate}
		...
		\begin{itemize}
			\item Si ya hay una sopa de letras creada, es decir, el objeto WordSearchObject es distinto de null, significa que anteriormente se ha pulsado en el botón de Vista Previa, o en el botón Aceptar pero hay un error. En este caso, si hay un mensaje de error se hace una llamada a \textit{generateWordSearch()}.
		...
		\begin{enumerate}
			...
			\begin{figure}[ht!]
				\begin{center}
					\includegraphics[width=0.74\textwidth]{Imagenes/Bitmap/flujoCreateWordSearch}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.75\textwidth]{Imagenes/Bitmap/wordsearchResult}
