...
\label{cap5:sec:implementacion}
	...
	\begin{itemize}
		...
		\item Rellenar huecos. Permite crear un ejercicio de completar con palabras los huecos, a partir de un texto inicial, haciendo clic en las palabras en las que se quiera dejar el hueco.
