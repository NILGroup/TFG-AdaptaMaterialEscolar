...
%-----------------------------------%
	...
	Así mismo, existe otra opción no relacionada con la creación de la sopa de letras y es la posibilidad de mostrar en el editor las palabras a buscar junto al enunciado.
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/definitionsOptions1}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/definitionsOptions2}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/definitionsResult}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/developOptions}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/developResult}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/truefalseOptions}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/truefalseResult}
			\caption{Resultado de ejercicio Verdadero o Falso}
			\label{fig:truefalseResult}
		\end{center}
	\end{figure}
	
	\subsubsection{Rellenar huecos}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/fillgapsOptions}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/fillgapsSelection}
	...
	\begin{figure}[ht!]
		\begin{center}
			\includegraphics[width=0.8\textwidth]{Imagenes/Bitmap/fillgapsResult}
