...
\label{cap4:sec:kanban}
	...
	\begin{itemize}
		\item \textit{To Do}: Se corresponden con las tareas que todavía no se han realizado.
...
\subsection{Pruebas de memoria}
	...
	Las pruebas de memoria consisten en buscar errores léxicos y gramaticales en la memoria, y corregirlos antes de su entrega, además de completarla con más información en el caso de que sea posible. En la figura \ref{fig:tableroKanban}, se puede ver como la tarea ``Introducción: Motivación'' está a la espera de ser aprobada (está en la columna \textit{Needs approval}).
