...
\label{cap6:sec:jorge}
	...
	También rediseñé la mayoría de la interfaz de usuario de nuestra aplicación, en concreto, la barra de herramientas de los ejercicios (\textit{toolbar}) y las ventanas modales de los éstos.
