...
\begin{resumen}
		En este capítulo se explica cómo se ha implementado la aplicación de AdaptaMaterialEscolar. En la sección \ref{cap6:sec:adaptamaterialescolar} se cuenta la aplicación AdaptaMaterialEscolar. En la sección \ref{cap6:sec:arquitectura} se explica la arquitectura utilizada. En la sección \ref{cap7:sec:componentes} se presentan los componentes que se han usado en la aplicación. Por último, en la sección \ref{cap7:sec:estructura} se muestra la estructura del código que se ha seguido.
\end{resumen}
